 ...
 * First Last
 * collaborators: Christopher, De Silva, Harrison Fung, Sam Lojacono
 */

/**A mathematical definition of a rational number that could be helpful is:
- a rational number can be expressed as a fraction
- a rational number can be expressed either as a repeating or TERMINATING decimal
...
public class Rational
{
  ...
  public boolean isRational(double value)
  {
